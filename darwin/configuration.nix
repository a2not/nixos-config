{
  ...
  #
  # TODO: retrieve username from whoami
  ...
  system = {
    ...
    # TODO: review
    # started off from https://github.com/ryan4yin/nix-darwin-kickstarter/blob/a458236698cd2e4e39d9e22b0874b54c9b18f98f/rich-demo/modules/system.nix
    #   defaults = {
